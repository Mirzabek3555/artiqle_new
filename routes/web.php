...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // Conferences
    Route::post('/conferences/generate', [AdminConferenceController::class , 'generate'])->name('conferences.generate');
    Route::delete('/conferences/destroy-month/{month}', [AdminConferenceController::class , 'destroyMonth'])
        ->name('conferences.destroy-month');
    ...
    // Articles
    // MUHIM: conferences-by-country ro'yxatni resource() dan OLDIN qo'yish kerak
    // Aks holda articles/{article} route uni o'zlashtiradi
    Route::get('/articles/conferences-by-country', [AdminArticleController::class , 'conferencesByCountry'])
        ->name('articles.conferences-by-country');
