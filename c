...
=======
        ...
        $fontImpact = file_exists($fd . 'LiberationSans-Bold.ttf') ? $fd . 'LiberationSans-Bold.ttf' : $fontB;
        $fontGeorgiaB = file_exists($fd . 'LiberationSerif-Bold.ttf') ? $fd . 'LiberationSerif-Bold.ttf' : (file_exists($fd . 'LiberationSerif-Bold.ttf') ? $fd . 'LiberationSerif-Bold.ttf' : $fontB);
>>>>>>> Stashed changes
