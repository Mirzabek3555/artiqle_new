<?php $__env->startSection('title', 'Archive - Konferensiya materiallari arxivlari'); ?>
                    ...
                    <a href="<?php echo e(route('conference.show', $conference)); ?>" class="text-decoration-none">
                        <div class="card conference-card h-100 border-0 shadow-sm overflow-hidden">
                            ...
                            <div class="card-img-top position-relative" style="height: 180px; overflow: hidden;">
                                <?php if($conference->country->cover_image): ?>
                                    <img src="<?php echo e(asset($conference->country->cover_image)); ?>" 
                                         alt="<?php echo e($conference->title); ?>"
                                    ...
                                    <div style="width: 100%; height: 100%; background: linear-gradient(135deg, #1a3a5f 0%, #0d2137 100%); display: flex; align-items: center; justify-content: center;">
                                        <?php if($conference->country->flag_url): ?>
                                            <img src="<?php echo e(Storage::url($conference->country->flag_url)); ?>" 
                                                 alt="<?php echo e($conference->country->name); ?>"
                                ...
                                <div class="position-absolute top-0 end-0 m-3">
                                    <span class="badge bg-secondary shadow-sm px-3 py-2">
                                        <i class="bi bi-calendar3 me-1"></i><?php echo e($conference->conference_date ? $conference->conference_date->format('d.m.Y') : \Carbon\Carbon::createFromFormat('Y-m', $conference->month_year)->translatedFormat('M Y')); ?>
                            ...
                            <div class="card-body p-4 d-flex flex-column">
                                <h6 class="card-title mb-2 flex-grow-1" style="color: var(--primary-blue); font-weight: 600; line-height: 1.4;">
                                    <?php echo e(Str::limit($conference->title, 100)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/artiqle_new/resources/views/public/archive/index.blade.php ENDPATH**/ ?>