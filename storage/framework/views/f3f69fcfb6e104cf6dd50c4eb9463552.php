<?php $__env->startSection('page-title', 'Konferensiyalar'); ?>
...
<?php $__env->startSection('content'); ?>
                    ...
                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                                ...
                                <?php else: ?>
                                    <span class="badge bg-secondary"><?php echo e($country->code); ?></span>
                                <?php endif; ?>
                            </td>
                            <td>
                                <strong><?php echo e($country->name); ?></strong>
                                <br>
                                <small class="text-muted"><?php echo e($country->name_en); ?></small>
                            </td>
                            <td>
                                <!-- Inline edit for conference name -->
                                <div class="conference-name-wrapper" data-country-id="<?php echo e($country->id); ?>">
                                    <div class="display-mode d-flex align-items-center">
                                        <?php if($country->conference_name && $country->conference_name !== 'Bu yerda konferensiya nomi yoziladi'): ?>
                                            <span class="text-success fw-bold conference-text">
                                                <i class="bi bi-check-circle me-1"></i><?php echo e($country->conference_name); ?>
                                    ...
                                    <div class="edit-mode d-none">
                                        <div class="input-group">
                                            <input type="text" class="form-control conference-input"
                                                value="<?php echo e(($country->conference_name && $country->conference_name !== 'Bu yerda konferensiya nomi yoziladi') ? $country->conference_name : ''); ?>"
                            ...
                            <td>
                                <a href="<?php echo e(route('admin.countries.edit', $country)); ?>" class="btn btn-sm btn-primary">
    ...
    <div class="card border-primary mb-4">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('admin.conferences.generate')); ?>" method="POST" class="row align-items-end g-3" onsubmit="return confirm('Rostan ham ushbu oy uchun barcha 10 ta konferensiyani generatsiya qilasizmi?')">
                <?php echo csrf_field(); ?>
                <div class="col-md-4">
                    <label class="form-label fw-bold">Oyni tanlang (shu jumladan o'tgan oylar)</label>
                    <input type="month" class="form-control" name="target_month" value="<?php echo e(date('Y-m')); ?>" required>
                </div>
                <div class="col-md-4">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo e(route('admin.conferences.create')); ?>" class="btn btn-primary btn-sm">
            ...
            <table class="table table-hover mb-0 align-middle">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $monthlyStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                                <strong class="fs-5 text-primary"><?php echo e(\Carbon\Carbon::createFromFormat('Y-m', $stat->month_year)->translatedFormat('F Y')); ?></strong>
                            </td>
                            <td><span class="badge bg-primary px-3 py-2" style="font-size: 0.9rem;"><?php echo e($stat->conferences_count); ?> ta</span></td>
                            <td><span class="badge bg-info text-dark px-3 py-2" style="font-size: 0.9rem;"><?php echo e($stat->articles_count); ?> ta</span></td>
                            <td><span class="badge bg-success">Faol</span></td>
                            <td class="text-end">
                                <a href="<?php echo e(route('admin.conferences.index', ['month' => $stat->month_year])); ?>" class="btn btn-sm btn-info text-white me-2">
                                    <i class="bi bi-eye me-1"></i>Ko'rish
                                </a>
                                <form action="<?php echo e(route('admin.conferences.destroy-month', $stat->month_year)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Rostan ham shu (<?php echo e($stat->month_year); ?>) oydagi BARCHA konferensiyalarni o\'chirmoqchimisiz? Bu amalni ortga qaytarib bo\'lmaydi!')">
                                    <?php echo csrf_field(); ?>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <span>
                <a href="<?php echo e(route('admin.conferences.index')); ?>" class="btn btn-sm btn-outline-secondary me-2">
                    <i class="bi bi-arrow-left"></i> Oylarga qaytish
                </a>
                <i class="bi bi-calendar-event me-2"></i>
                <?php echo e($selectedMonth === 'all' ? 'Barcha konferensiyalar' : \Carbon\Carbon::createFromFormat('Y-m', $selectedMonth)->translatedFormat('F Y') . ' konferensiyalari'); ?>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $conferences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conference): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td style="max-width: 300px;">
                                <div class="text-truncate" title="<?php echo e($conference->title); ?>">
                                    <strong><?php echo e($conference->title); ?></strong>
                                </div>
                            </td>
                            <td>
                                <?php if($conference->start_date && $conference->end_date): ?>
                                    <?php echo e($conference->start_date->format('d.m')); ?> - <?php echo e($conference->end_date->format('d.m.Y')); ?>

                                <?php else: ?>
                                    <?php echo e($conference->conference_date->format('d.m.Y')); ?>

                                <?php endif; ?>
                            </td>
                            <td><span class="badge bg-primary"><?php echo e($conference->articles_count); ?></span></td>
                            <td>
                            ...
                            <td>
                                ...
                                <form action="<?php echo e(route('admin.conferences.destroy', $conference)); ?>" method="POST"
        ...
        <?php if($conferences->hasPages()): ?>
            <div class="card-footer"><?php echo e($conferences->links()); ?></div>
        <?php endif; ?>
    </div>
    <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/artiqle_new/resources/views/admin/conferences/index.blade.php ENDPATH**/ ?>