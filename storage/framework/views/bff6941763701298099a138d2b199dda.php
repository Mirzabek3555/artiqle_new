...
<head>
    ...
    <title><?php echo e($conference->title); ?> - Maqolalar to'plami</title>
    <style>
        /* ─── Global ─────────────────────────────────────────────── */
        * {
            margin: 0;
        ...
        .sidebar-top-bar {
            ...
            height: 4mm;
            background: <?php echo e($colors['primary'] ?? '#1a3a5f'); ?>;
        }
        ...
        .sidebar-bottom-bar {
            ...
            height: 4mm;
            background: <?php echo e($colors['accent'] ?? '#c9a227'); ?>;
        }
        ...
        .sidebar-brand {
            ...
            font-size: 22pt;
            font-weight: 700;
            color: <?php echo e($colors['primary'] ?? '#1a3a5f'); ?>;
            text-transform: uppercase;
            letter-spacing: 4px;
            opacity: 0;
        }
        ...
        .article-header {
            ...
            margin-bottom: 7mm;
            padding-bottom: 3mm;
            border-bottom: 2px solid <?php echo e($colors['primary'] ?? '#1a3a5f'); ?>;
        }
        ...
        .article-author {
            ...
            font-size: 11pt;
            font-weight: 700;
            color: <?php echo e($colors['secondary'] ?? '#2980b9'); ?>;
            margin-bottom: 1mm;
        }
        ...
        .abstract-block {
            font-size: 9.5pt;
            background: #f8f9fa;
            border-left: 4px solid <?php echo e($colors['accent'] ?? '#c9a227'); ?>;
            padding: 4mm 5mm;
            margin-bottom: 7mm;
            text-align: justify;
        }
...
<div class="cover-page">
    ...
    <div style="
        ...
        text-transform: uppercase;
        letter-spacing: 2px;
    "><?php echo e(strtoupper($country->name_en ?? $country->name)); ?></div>
    ...
    <div style="
        ...
        text-transform: uppercase;
        line-height: 1.4;
    "><?php echo e($conference->title); ?></div>
    ...
    <div style="
        ...
        font-weight: 900;
        text-transform: uppercase;
        border-top: 1px solid <?php echo e($accent); ?>;
        padding-top: 8px;
...
<div class="info-page" style="padding: 20mm;">
    ...
    <div style="text-align: center;">
        ...
        <div style="font-family: 'Times New Roman', Times, serif; font-weight: bold; font-size: 13px; line-height: 1.4; margin-bottom: 25px;">
            “<?php echo e($conference->title); ?>”. Collection of
            scientific papers on materials of the international scientific-practical conference
            <?php echo e($conference->conference_date->format('d.m.Y')); ?>, Pub. "ISOC", <?php echo e(strtoupper($country->name_en ?? $country->name)); ?>, <?php echo e($country->name_en ?? $country->name); ?>, <?php echo e($articles->count() * 4); ?> p.
        </div>
...
<div class="article-page">
    ...
    <div class="article-footer">
        <?php echo e($conference->title); ?> | <?php echo e($country->name_en ?? $country->name); ?> | <?php echo e($conference->conference_date->format('Y')); ?>
    ...
    <div class="article-header">
        <div class="article-conf-name"><?php echo e($country->conference_name ?? 'INTERNATIONAL SCIENTIFIC CONFERENCES'); ?></div>
        <div class="article-conf-date">
            <?php echo e($conference->conference_date->format('jS F Y')); ?>
    ...
    <?php if($article->abstract): ?>
        <div class="abstract-block">
            ...
            <?php if($article->keywords): ?>
                <br><br>
                <strong>Keywords:</strong> <?php echo e($article->keywords); ?>
    ...
    <?php if($article->references): ?>
        <div class="article-references">
            ...
            <div style="margin-top: 2mm;">
                <?php echo nl2br(e($article->references)); ?>
...
</html><?php /**PATH /var/www/artiqle_new/resources/views/pdf/collection.blade.php ENDPATH**/ ?>