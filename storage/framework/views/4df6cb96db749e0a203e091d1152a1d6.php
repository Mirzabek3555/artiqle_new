...
<body>
    <div class="cover">
                ...
                <tr>
                    <td style="width:100%; text-align:center; vertical-align:middle;">
                        <div class="conference-title-header">
                            <?php echo e($country->conference_name ?? strtoupper($country->name_en) . ' DEVELOPMENTS AND RESEARCH IN EDUCATION'); ?>
        ...
        <!-- Flag Decoration -->
        <?php if($country->flag_url && file_exists(storage_path('app/public/' . $country->flag_url))): ?>
            <div class="flag-decoration">
                <img src="<?php echo e(storage_path('app/public/' . $country->flag_url)); ?>" alt="Flag">
            </div>
        <?php endif; ?>
        ...
        <div class="conference-section">
            ...
            <div class="conference-name"><?php echo e($country->conference_name ?? $conference->title); ?></div>
        </div>
        ...
        <div class="country-section">
            <?php if($country->cover_image && file_exists(public_path($country->cover_image))): ?>
                <div class="country-bg">
                    <img src="<?php echo e(public_path($country->cover_image)); ?>" alt="">
                </div>
            <?php endif; ?>
            <div class="country-content">
                <div class="country-name"><?php echo e(strtoupper($country->name_en)); ?>

                    <?php echo e($conference->conference_date->format('Y')); ?></div>
                <div class="country-date"><?php echo e($conference->conference_date->format('F d, Y')); ?></div>
            </div>
        </div>
        ...
        <div class="footer">
            <table class="footer-table">
                <tr>
                    <td class="footer-left" style="width:30%;">ARTIQLE <?php echo e(date('Y')); ?></td>
                    <td class="footer-center" style="width:40%;">
                        <span class="page-badge"><?php echo e($article->page_range); ?></span>
                    </td>
...
<?php /**PATH /var/www/artiqle_new/resources/views/pdf/article-cover.blade.php ENDPATH**/ ?>