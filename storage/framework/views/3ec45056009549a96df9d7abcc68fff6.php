    ...
    <div class="certificate-container">
        ...
        <div class="left-section">
            ...
            <?php if($hasWatermark): ?>
                <div class="watermark-layer">
                    <img src="<?php echo e($watermarkPath); ?>" alt="">
                </div>
            <?php endif; ?>

            <!-- Coat of Arms watermark (fallback) -->
            <?php if($hasCountryImage && !$hasWatermark): ?>
                <div class="coat-of-arms">
                    <img src="<?php echo e($countryImagePath); ?>" alt="">
                </div>
            <?php endif; ?>

            <!-- Country header -->
            <div class="country-header">
                <div class="country-name-top"><?php echo e(strtoupper($country->name_en ?? $country->name)); ?></div>
            </div>
            ...
            <?php if($hasFlag): ?>
                <div class="flags-row">
                    <img src="<?php echo e($flagPath); ?>" class="flag-small" alt="Flag">
                    <img src="<?php echo e($flagPath); ?>" class="flag-small" alt="Flag">
                </div>
            <?php endif; ?>
            ...
            <div class="conference-info">
                ...
                <div class="conference-name-text">
                    &lt;&lt;<span
                        class="conference-name-highlight"><?php echo e(strtoupper($country->conference_name ?? $conference->title)); ?></span>&gt;&gt;
            ...
            <div class="article-title-section">
                <div class="article-title-text"><?php echo e(strtoupper($article->title)); ?></div>
            </div>
                    ...
                    <tr>
                        ...
                        <td style="width: 25%;">
                            <div class="date-section">
                                <div class="date-value"><?php echo e($certificate->issue_date->format('d.m.Y')); ?></div>
                            </div>
                        </td>
                        <td style="width: 25%;">
        ...
        <div class="right-section">
            ...
            <div class="country-images">
                <?php if($hasCountryImage): ?>
                    <div class="country-image-main">
                        <img src="<?php echo e($countryImagePath); ?>" alt="<?php echo e($country->name); ?>">
                    </div>
                <?php elseif($hasCoverImage): ?>
                    <div class="country-image-main">
                        <img src="<?php echo e($coverImagePath); ?>" alt="<?php echo e($country->name); ?>">
                    </div>
                <?php endif; ?>

                <?php if($hasCoverImage && $hasCountryImage): ?>
                    <div class="country-image-bottom">
                        <img src="<?php echo e($coverImagePath); ?>" alt="<?php echo e($country->name); ?>">
                    </div>
                <?php elseif($hasCountryImage): ?>
                    <div class="country-image-bottom">
                        <img src="<?php echo e($countryImagePath); ?>" alt="<?php echo e($country->name); ?>">
                    </div>
                <?php endif; ?>
            ...
            <div class="isoc-logo-section">
                <?php if($hasIsocLogo): ?>
                    <img src="<?php echo e($isocLogoPath); ?>" class="isoc-logo-img" alt="ISOC">
                <?php else: ?>
        ...
        <div class="qr-code-section">
            ...
            <?php else: ?>
                <?php echo SimpleSoftwareIO\QrCode\Facades\QrCode::format('svg')->size(60)->color(26, 58, 95)->generate('https://internationalscientificconferences.org'); ?>
        ...
        <!-- Certificate Number -->
        <div class="cert-number">№ <?php echo e($certificate->certificate_number); ?></div>
    </div>
</body>

</html><?php /**PATH /var/www/artiqle_new/resources/views/pdf/certificate-new.blade.php ENDPATH**/ ?>