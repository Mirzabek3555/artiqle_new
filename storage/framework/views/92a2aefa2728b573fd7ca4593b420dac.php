...
<body>
    ...
    <?php if($watermarkBase64): ?>
        <div class="watermark">
            <img src="<?php echo e($watermarkBase64); ?>" alt="">
        </div>
    <?php endif; ?>

    <!-- Certificate ID -->
    <div class="cert-id">№ <?php echo e($certNumber); ?></div>

    <!-- Date badge -->
    <div class="cert-date-badge">
        <div class="cert-date-value"><?php echo e($issueDate); ?></div>
    ...
    <div class="content-area">
        ...
        <div class="header-logo">
            <?php if($iscLogoBase64): ?>
                <img src="<?php echo e($iscLogoBase64); ?>" alt="ISC">
            <?php endif; ?>
        </div>
        ...
        <div style="text-align: center;">
            <div class="conference-banner">
                <div class="conference-banner-text"><?php echo e($countryNameDisplay); ?></div>
            </div>
        </div>
        ...
        <!-- Author Name -->
        <div class="author-name"><?php echo e($authorName); ?></div>

        <!-- Article info -->
        <div class="article-info">
            <div class="article-label">has published a scientific article entitled</div>
            <div class="article-title-text">"<?php echo e($articleTitle); ?>"</div>
        </div>

        <!-- Conference details -->
        <div class="conf-details">
            <div class="conf-label">at the international scientific online conference</div>
            <div class="conf-name-text">"<?php echo e($conferenceName); ?>"</div>
            <div class="country-text"><?php echo e($countryNameDisplay); ?> · <?php echo e($confDate); ?></div>
        </div>
            ...
            <table class="metadata-table">
                <tr>
                    <td>
                        ...
                        <div class="meta-value"><?php echo e($certNumber); ?></div>
                    </td>
                    <td class="meta-divider"></td>
                    <td>
                        <div class="meta-label">Country</div>
                        <div class="meta-value"><?php echo e($country->name_en ?? $country->name); ?></div>
                    </td>
                    <td class="meta-divider"></td>
                    <td>
                        <div class="meta-label">Date</div>
                        <div class="meta-value"><?php echo e($issueDate); ?></div>
                    </td>
                </tr>
            </table>
        </div>
                    ...
                    <td class="footer-left">
                        <?php if($qrBase64): ?>
                            <div class="qr-code-box">
                                <img src="<?php echo e($qrBase64); ?>" alt="QR">
                            </div>
...
</html><?php /**PATH /var/www/artiqle_new/resources/views/pdf/certificate-professional.blade.php ENDPATH**/ ?>