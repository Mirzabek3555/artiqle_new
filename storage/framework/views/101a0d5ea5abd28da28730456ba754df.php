...
<body>
    <div class="page">
        ...
        <div class="brand-section">
            ...
            ?>
            <?php if($logoData): ?>
                <img src="data:image/png;base64,<?php echo e($logoData); ?>" alt="ISC Logo" class="brand-logo-img">
            <?php else: ?>
                <div style="text-align: center; margin-bottom: 3mm;">
                    <span
                        style="font-family: 'DejaVu Sans', sans-serif; font-size: 24px; font-weight: 800; color: <?php echo e($colors['primary'] ?? '#1a5276'); ?>;">ISC</span>
                </div>
            <?php endif; ?>
            <div class="brand-name">International Scientific Conferences</div>
            <div class="conference-name">
                <?php echo e($country->conference_name ?? ($country->name_en ?? $country->name) . ' Scientific Conference'); ?>

            </div>
            <div class="country-badge">
                <?php echo e($country->name_en ?? $country->name); ?> |
                <?php echo e($conference->conference_date ? $conference->conference_date->format('F Y') : now()->format('F Y')); ?>
        ...
        <div class="article-section">
            ...
            <div class="author-block">
                ...
                <?php if($article->co_authors): ?>
                    <div style="margin-top: 2mm; padding-top: 2mm; border-top: 1px dashed #ccc;">
                        <?php $__currentLoopData = explode("\n", $article->co_authors); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coAuthor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(trim($coAuthor)): ?>
                                <div style="font-size: 9pt; color: #555;"><?php echo e(trim($coAuthor)); ?></div>
                            <?php endif; ?>
            ...
            <table class="metadata-grid">
                <tr>
                    ...
                    <td class="metadata-value"><?php echo e($article->page_range ?? 'N/A'); ?></td>
                </tr>
                <tr>
                    <td class="metadata-label">Conference</td>
                    <td class="metadata-value"><?php echo e($conference->title ?? 'International Scientific Conference'); ?></td>
                </tr>
                <tr>
                    <td class="metadata-label">Country</td>
                    <td class="metadata-value"><?php echo e($country->name_en ?? $country->name); ?></td>
                </tr>
                <tr>
                    <td class="metadata-label">Publication Date</td>
                    <td class="metadata-value">
                        <?php echo e($article->published_at ? $article->published_at->format('d F Y') : now()->format('d F Y')); ?>
                ...
                <?php if($article->article_link): ?>
                    <tr>
                        ...
                        <td class="metadata-value"><?php echo e($article->article_link); ?></td>
                    </tr>
                <?php endif; ?>
            </table>
        </div>
...
</html><?php /**PATH /var/www/artiqle_new/resources/views/pdf/article-metadata-page.blade.php ENDPATH**/ ?>