...
<head>
    <meta charset="UTF-8">
    <title>Certificate - <?php echo e($certificate->certificate_number); ?></title>
    <style>
        @page {
            margin: 0;
            size: A4 landscape;
...
<tr>
    ...
    <!-- ========== LEFT CELL ========== -->
    <td class="cell-left" style="background-color: <?php echo e($pc1); ?>; border-right-color: <?php echo e($accent); ?>;">

        <!-- Yuqori rang stripe -->
        <div class="stripe-top" style="background-color: <?php echo e($pc2); ?>;"></div>

        <!-- Logo va sayt nomi -->
        <div class="left-logo-area">
            <?php if($logoB64): ?>
            <img src="<?php echo e($logoB64); ?>" alt="Logo">
            <?php endif; ?>
            <span class="left-logo-text" style="color: <?php echo e($txtColor); ?>;">ARTIQLE.UZ</span>
        </div>
        ...
        <div class="left-body">
            ...
            <table width="80%" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                <tr>
                    <td style="height:6px; background-color: <?php echo e($pc1); ?>;"></td>
                </tr>
                <tr>
                    <td style="height:6px; background-color: <?php echo e($pc2 != '#ffffff' ? $pc2 : 'rgba(255,255,255,0.3)'); ?>;"></td>
                </tr>
                <tr>
                    <td style="height:6px; background-color: <?php echo e($pc3); ?>;"></td>
                </tr>
            </table>
            ...
            <?php if($flagB64): ?>
            <br>
            <img class="flag-img" src="<?php echo e($flagB64); ?>" alt="<?php echo e($countryName); ?>">
            <?php endif; ?>

            <div class="country-name" style="color: <?php echo e($txtColor); ?>;">
                <?php echo e(mb_strtoupper($countryName)); ?>

            </div>

            <div style="height: 1px; background-color: rgba(255,255,255,0.3); margin: 5mm 0;"></div>

            <div style="font-size:6pt; color: <?php echo e($txtColor); ?>; opacity: 0.7; letter-spacing: 1px;">
                INTERNATIONAL<br>SCIENTIFIC<br>CONFERENCES
            </div>
        </div>

        <!-- Pastki rang stripe -->
        <div class="stripe-bottom" style="background-color: <?php echo e($pc3); ?>;"></div>
    ...
    <td class="cell-right">
        ...
        <!-- Yuqori rang tasma -->
        <div class="right-top-bar" style="background-color: <?php echo e($primary); ?>;"></div>

        <div class="right-content">

            <!-- CERTIFICATE sarlavhasi -->
            <div class="cert-header" style="background-color: <?php echo e($primary); ?>;">
                ...
                <!-- Chap aksent barchiq -->
                <div class="cert-header-accent" style="background-color: <?php echo e($accent); ?>;"></div>
            </div>

            <!-- Oluvchi ismi -->
            <div class="recipient-name">
                <?php echo e($nameLine1); ?><?php if($nameLine2 && $nameLine2 !== $nameLine1): ?><br><?php echo e($nameLine2); ?><?php endif; ?>
            </div>
            <div class="name-underline" style="background-color: <?php echo e($primary); ?>; width: 70mm;"></div>

            <!-- Maqola sarlavhasi -->
            <div class="paper-label">FOR PARTICIPATION AND PUBLICATION OF THE PAPER ENTITLED</div>
            <div class="paper-title"><?php echo e(strtoupper($shortTitle)); ?></div>

            <!-- Konferensiya tavsif -->
            <div class="conf-text">
                In an International Conference on <b><?php echo e($confTitle); ?></b>,
                Published online with <b>International conferences of practice</b> publications,
                Hosted online from <b><?php echo e($countryName); ?></b>
            </div>

            <!-- Footer -->
            <div class="footer-bar">
                <div class="foot-left">
                    <div class="date-val">Date: <?php echo e($issueDate); ?></div>
                    <div class="cert-num-txt">№ <?php echo e($certNumber); ?></div>
                </div>
                <div class="foot-mid">
                    <?php if($openAccess): ?>
                    <img class="seal-img" src="<?php echo e($openAccess); ?>" alt="Open Access">
                    <?php else: ?>
                    <div style="width:34px;height:34px;border-radius:17px;border:2px solid <?php echo e($accent); ?>;
                         margin:0 auto;padding-top:8px;text-align:center;">
                        <span style="font-size:4.5pt;color:<?php echo e($accent); ?>;font-weight:bold;line-height:1.3;">OPEN<br>ACCESS</span>
                    </div>
                    <?php endif; ?>
                </div>
                <div class="foot-right">
                    <?php if($signature): ?>
                    <img class="sig-img" src="<?php echo e($signature); ?>" alt="Signature">
                    <?php endif; ?>
                    <span class="sig-rule" style="background-color: <?php echo e($primary); ?>;"></span>
        ...
        <!-- Pastki rang tasma -->
        <div class="right-bottom-bar" style="background-color: <?php echo e($secondary); ?>;"></div>
...
<?php /**PATH /var/www/artiqle_new/resources/views/pdf/certificate-premium.blade.php ENDPATH**/ ?>