<?php $__env->startSection('page-title', 'Davlatlar'); ?>

<?php $__env->startSection('content'); ?>
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center bg-primary text-white">
            <span><i class="bi bi-globe me-2"></i>Barcha davlatlar (<?php echo e($countries->count()); ?>)</span>
            <a href="<?php echo e(route('admin.countries.create')); ?>" class="btn btn-light btn-sm">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <br>
                                <small class="text-muted"><?php echo e($country->name_en); ?> (<?php echo e($country->code); ?>)</small>
                            </td>
                            <td>
                                <span class="badge bg-info"><?php echo e($country->schedule_order); ?></span>
                            </td>
                            <td>
                                ...
                                <div class="conference-name-wrapper" data-country-id="<?php echo e($country->id); ?>">
                                    <div class="display-mode">
                                        <?php if($country->conference_name && $country->conference_name !== 'Bu yerda konferensiya nomi yoziladi'): ?>
                                            <span
                                                class="text-primary fw-bold conference-text"><?php echo e($country->conference_name); ?></span>
                                        <?php else: ?>
                                    ...
                                    <div class="edit-mode d-none">
                                        <div class="input-group input-group-sm">
                                            <input type="text" class="form-control conference-input"
                                                value="<?php echo e($country->conference_name !== 'Bu yerda konferensiya nomi yoziladi' ? $country->conference_name : ''); ?>"
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="<?php echo e(route('admin.countries.show', $country)); ?>" class="btn btn-sm btn-outline-info"
                                        title="Ko'rish">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    ...
                                    <a href="<?php echo e(route('admin.articles.index', ['country' => $country->id])); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/artiqle_new/resources/views/admin/countries/index.blade.php ENDPATH**/ ?>