<?php $__env->startSection('page-title', 'Davlatni tahrirlash'); ?>

<?php $__env->startSection('content'); ?>
    <div class="card">
        <div class="card-header bg-primary text-white">
            <i class="bi bi-pencil me-2"></i><?php echo e($country->name); ?> - tahrirlash
        </div>
        <div class="card-body">
            <?php if($errors->any()): ?>
            ...
            <form action="<?php echo e(route('admin.countries.update', $country)); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg text-center text-uppercase"
                                    name="code" value="<?php echo e(old('code', $country->code)); ?>" maxlength="3" required>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label fw-bold">Taqsimot Tartibi</label>
                                <input type="number" class="form-control form-control-lg text-center"
                                    name="schedule_order" value="<?php echo e(old('schedule_order', $country->schedule_order)); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-lg" name="conference_name"
                                value="<?php echo e(old('conference_name', $country->conference_name)); ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="conference_description" rows="3"
                                placeholder="Konferensiya haqida qisqacha ma'lumot..."><?php echo e(old('conference_description', $country->conference_description)); ?></textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="is_active" id="is_active"
                                style="width: 3em; height: 1.5em;" <?php echo e($country->is_active ? 'checked' : ''); ?>>
                ...
                <div class="d-flex gap-2 justify-content-between">
                    <a href="<?php echo e(route('admin.countries.index')); ?>" class="btn btn-outline-secondary btn-lg">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/artiqle_new/resources/views/admin/countries/edit.blade.php ENDPATH**/ ?>