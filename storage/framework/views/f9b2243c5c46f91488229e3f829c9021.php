...
<head>
    <meta charset="UTF-8">
    <title>Sertifikat - <?php echo e($certificate->certificate_number); ?></title>
    <style>
        @page {
            margin: 0;
            size: A4 landscape;
...
<body>
    <div class="certificate">
        ...
        <div class="content">
            ...
            <div class="recipient"><?php echo e($author->name); ?></div>

            <div class="article-title">"<?php echo e($article->title); ?>"</div>

            <div class="conference">
                <strong><?php echo e($conference->title); ?></strong><br>
            ...
            <div class="footer">
                <div class="footer-item">
                    ...
                    <div class="footer-value"><?php echo e($conference->conference_date->format('d.m.Y')); ?></div>
                </div>
                <div class="footer-item">
                    <div class="footer-label">Sahifalar</div>
                    <div class="footer-value"><?php echo e($article->page_range); ?></div>
                </div>
                <div class="footer-item">
                    <div class="footer-label">Berilgan sana</div>
                    <div class="footer-value"><?php echo e($certificate->issue_date->format('d.m.Y')); ?></div>
                </div>
            </div>
...
</html><?php /**PATH /var/www/artiqle_new/resources/views/pdf/certificate.blade.php ENDPATH**/ ?>