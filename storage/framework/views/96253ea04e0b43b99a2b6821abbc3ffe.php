...
<body>
    ...
    <!-- Watermark (Optional) -->
    <?php if(file_exists(public_path('images/logos/isc-logo.png'))): ?>
        <img src="<?php echo e(public_path('images/logos/isc-logo.png')); ?>" class="watermark">
    <?php endif; ?>
    ...
    <div class="sidebar-container">
        ...
        <div class="sidebar-logo">
            ...
            <?php else: ?>
                <div style="font-weight:bold; font-size:18pt; color: <?php echo e($colors['primary']); ?>; transform: rotate(-90deg);">
                    ISC</div>
            <?php endif; ?>
        </div>
    ...
    <!-- Header -->
    <div class="header">
        <div class="header-conf-name"><?php echo e($country->conference_name ?? 'INTERNATIONAL SCIENTIFIC CONFERENCES'); ?></div>
        <div class="header-date">Date: <?php echo e($conference->conference_date->format('jS F Y')); ?></div>
    </div>
...
</html><?php /**PATH /var/www/artiqle_new/resources/views/pdf/article-full.blade.php ENDPATH**/ ?>