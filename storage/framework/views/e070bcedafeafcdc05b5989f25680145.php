...
<body>
    ...
    <div class="left-sidebar">
        ...
        <?php if($hasHeaderImage): ?>
            <div class="sidebar-header-image">
                <img src="<?php echo e($headerImagePath); ?>" alt="">
            </div>
        <?php endif; ?>
        ...
        <?php if($hasLogo): ?>
            <div class="sidebar-logo">
                <img src="<?php echo e($logoPath); ?>" alt="ISC">
            </div>
        <?php endif; ?>
    </div>
    ...
    <div class="main-content">
        ...
        <div class="header-section">
            <div class="conference-name"><?php echo e($country->conference_name ?? 'International Scientific Online Conference'); ?>

            </div>
            <div class="conference-details">
                <?php echo e($conference->title ?? 'Scientific Research Publication'); ?> •
                <?php echo e($conference->conference_date ? $conference->conference_date->format('F d, Y') : now()->format('F d, Y')); ?>
        ...
        <div class="article-meta">
            <span class="meta-row">
                ...
                <span class="meta-value"><?php echo e($article->page_range ?? 'N/A'); ?></span>
            </span>
            <span class="meta-row">
                <span class="meta-label">Published:</span>
                <span
                    class="meta-value"><?php echo e($article->published_at ? $article->published_at->format('d.m.Y') : now()->format('d.m.Y')); ?></span>
            </span>
            <?php if($article->article_link): ?>
                <span class="meta-row">
                    <span class="meta-label">DOI:</span>
                    <span class="meta-value"><?php echo e($article->article_link); ?></span>
                </span>
            <?php endif; ?>
        </div>
        ...
        <!-- Main Content -->
        <?php if(!empty($isDocxContent ?? false) && !empty($processedHtml ?? '')): ?>
                ...
                <div class="content-section">
                    <?php if($section['title']): ?>
                        <div class="section-title">
                            <?php if($section['number']): ?>
                                <span class="section-number"><?php echo e($section['number']); ?>.</span>
                            <?php endif; ?>
...
</html><?php /**PATH /var/www/artiqle_new/resources/views/pdf/article-incop-style.blade.php ENDPATH**/ ?>